...
public class AssetHandler {
    ...
    public ArrayList<String> getAssets_with_assigned_to() {
        ...
        try {
            String query = "SELECT su.user_first_name+' '+su.user_last_name \"added_by_name\",su.user_email \"added_by_email\","
                    ...
                    + "full join " + MSSQLConnection.getDBName() + ".dbo.CARO_asset_category ac ON (a.asset_category=ac.asset_category)"
                    + "full join " + MSSQLConnection.getDBName() + ".dbo.CARO_vendor v ON (a.vendor_id=v.vendor_id)"
                    + "full join " + MSSQLConnection.getDBName() + ".dbo.CARO_system_user su ON (a.added_by=su.personel_id)"
                    + "full join " + MSSQLConnection.getDBName() + ".dbo.CARO_brand b ON (a.brand_id=b.brand_id)"
                    + "full join " + MSSQLConnection.getDBName() + ".dbo.CARO_location l ON (a.location_id=l.location_id) "
                    + "full join " + MSSQLConnection.getDBName() + ".dbo.CARO_assigned_to a_t ON (a_t.asset_id = a.asset_id)"
                    + "full join " + MSSQLConnection.getDBName() + ".dbo.CARO_system_user su2 ON (a_t.personel_id = su2.personel_id)"
                    + "full join " + MSSQLConnection.getDBName() + ".dbo.CARO_depreciation_information di ON (a.deprec_info_id = di.deprec_info_id)"
    ...
    public ArrayList<String> getArchiveParams(String asset_id)
    {
        ...
        try
        {
            String query = "SELECT asset_id, purchase_date, cost ,"
                    + "asset_name, asset_desc, comment_on_asset, asset_category   FROM "+MSSQLConnection.getDBName()+".dbo.CARO_asset "
                    + "WHERE asset_id = ? ";
            PreparedStatement st = conn.prepareStatement(query);
    ...
    public ArrayList<String> getAssetBrands()
    {
        ...
        try
        {
            String query = "SELECT * FROM "+MSSQLConnection.getDBName()+".dbo.CARO_brand";
            PreparedStatement st = conn.prepareStatement(query);
            ResultSet rs = st.executeQuery();
            while (rs.next()){
                String result;
    ...
    public ArrayList<String> getAssetVendors()
    {
        ...
        try
        {
            String query = "SELECT * FROM "+MSSQLConnection.getDBName()+".dbo.CARO_vendor";
            PreparedStatement st = conn.prepareStatement(query);
            ResultSet rs = st.executeQuery();
            while (rs.next()){
                String result;
    ...
    public ArrayList<String> getLocations()
    {
        ...
        try
        {
            String query = "SELECT * FROM "+MSSQLConnection.getDBName()+".dbo.CARO_location";
            PreparedStatement st = conn.prepareStatement(query);
            ResultSet rs = st.executeQuery();
            while (rs.next()){
                String result;
    ...
    public ArrayList<String> getMinMaxDate()
    {
        ...
        try
        {
            String query = "SELECT MIN(purchase_date), MAX(purchase_date) FROM "+MSSQLConnection.getDBName()+".dbo.CARO_asset";
            PreparedStatement st = conn.prepareStatement(query);
            ResultSet rs = st.executeQuery();
            while (rs.next()){
    ...
    public ArrayList<Double> getMinMaxCost()
    {
        ...
        try
        {
            String query = "SELECT MIN(cost), MAX(cost) FROM "+MSSQLConnection.getDBName()+".dbo.CARO_asset";
            PreparedStatement st = conn.prepareStatement(query);
            ResultSet rs = st.executeQuery();
            while (rs.next()){
    ...
    public ArrayList<String> getActiveUsers()
    {
        ...
        try
        {
            String query = "SELECT * FROM "+MSSQLConnection.getDBName()+".dbo.CARO_system_user WHERE isActive = 1 ;";
            PreparedStatement st = conn.prepareStatement(query);
            ResultSet rs = st.executeQuery();
    ...
    public boolean addAsset(String[] params) {
        ...
        int result = 0;
        try {
            String query = "INSERT INTO " + MSSQLConnection.getDBName() + ".dbo.CARO_asset "
    ...
    public boolean addToArchive(ArrayList<String> archiveParams) {
        ...
        int result = 0;
        try {
            String query = "INSERT INTO " + MSSQLConnection.getDBName() + ".dbo.CARO_asset_sold_archive "
    ...
    public boolean addAssigned_to(String[] params) {
        ...
        int result = 0;
        try {
            String query = "INSERT INTO " + MSSQLConnection.getDBName() + ".dbo.CARO_assigned_to "
                    + "VALUES (?, ?);";
            PreparedStatement st = conn.prepareStatement(query);
            st.setString(1, params[0]);
            st.setString(2, params[1]);
    ...
    public boolean deleteAsset(String assetID) {
        ...
        int result = 0;
        try {
            String query = "DELETE FROM " + MSSQLConnection.getDBName() + ".dbo.CARO_asset "
                    + "WHERE asset_id=?;";
            PreparedStatement st = conn.prepareStatement(query);
    ...
    public boolean deleteAssigned_to(String assigned_to_personel_id, String assigned_to_asset_id) {
        ...
        int result = 0;
        try {
            String query = "DELETE FROM " + MSSQLConnection.getDBName() + ".dbo.CARO_assigned_to "
    ...
    public boolean editAsset(String[] params) {
        ...
        try {
            String query = "UPDATE " + MSSQLConnection.getDBName() + ".dbo.CARO_asset "
    ...
    public boolean editAssigned_to(String NEW_assigned_to_personel_id, String OLD_assigned_to_personel_id, String assigned_to_asset_id) {
        ...
        int result = 0;
        try {
            String query = "UPDATE " + MSSQLConnection.getDBName() + ".dbo.CARO_assigned_to "
                    + "SET personel_id = ? "
                    + "WHERE personel_id = ? AND asset_id = ?";
            PreparedStatement st = conn.prepareStatement(query);
