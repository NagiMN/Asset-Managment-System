...
public class DepreciationHandler {
    ...
    public ArrayList<String> getDepreciations()
    {
        ...
        try
        {
            String query = "SELECT deprec_info_id, deprec_desc "
                    + "FROM "+MSSQLConnection.getDBName()+".dbo.CARO_depreciation_information";
    ...
    public ArrayList<String> getTimeIntervals()
    {
        ...
        {
            String query = "SELECT * "
                    + "FROM "+MSSQLConnection.getDBName()+".dbo.CARO_depreciation_time_interval";
    ...
    public boolean addDepreciation(String[] params)
    {
        ...
        try
        {
            String query = "INSERT INTO "+MSSQLConnection.getDBName()+".dbo.CARO_depreciation_information "
    ...
    public boolean deleteDepreciation(String deprec_info_id)
    {
        ...
        try
        {
            String query = "DELETE FROM "+MSSQLConnection.getDBName()+".dbo.CARO_depreciation_information "
                    + "WHERE deprec_info_id=?;";
            PreparedStatement st = conn.prepareStatement(query);
            st.setString(1, deprec_info_id);
    ...
    public boolean updateDepreciationInfo(String[] params)
    {
        ...
        try
        {
            String query = "UPDATE "+MSSQLConnection.getDBName()+".dbo.CARO_depreciation_information "
