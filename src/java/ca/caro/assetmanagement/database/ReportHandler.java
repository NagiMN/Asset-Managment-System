...
public class ReportHandler {
    ...
    public String getTestAssetsInCSV() {
        ...
        String resultInCSV = "";
        try {
            String query = "SELECT * FROM " + MSSQLConnection.getDBName() + ".dbo.CARO_asset";
    ...
    public String getLocationReport() {
        ...
        String resultInCSV = "";
        try {
            String query = "SELECT * FROM " + MSSQLConnection.getDBName() + ".dbo.CARO_location l ";
    ...
    public String getBrandReport() {
        ...
        String resultInCSV = "";
        try {
            String query = "SELECT * FROM " + MSSQLConnection.getDBName() + ".dbo.CARO_brand b ";
    ...
    public String getVendorReport() {
        ...
        String resultInCSV = "";
        try {
            String query = "SELECT * FROM " + MSSQLConnection.getDBName() + ".dbo.CARO_vendor v ";
